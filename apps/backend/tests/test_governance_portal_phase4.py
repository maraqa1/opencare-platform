...
class GovernancePortalPhase4Tests(unittest.TestCase):
    ...
    def test_v1_3_wireframe_zones_are_represented_in_viewer_pages(self):
        ...
        self.assertIn("Clickable Nodes", lineage)
        self.assertIn("Observed Edges", lineage)
        self.assertIn("gv2-lineage-workspace", panels)
        self.assertIn("gv2-lineage-lane", panels)
        self.assertIn("Open Table Detail", panels)
