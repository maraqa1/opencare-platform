...
import { RevenueCycleJourney } from "../RevenueCycleJourney";
  ...
  return (
    <div style={{ fontFamily: "var(--font-body)", color: "var(--oc-gray-900)" }}>
      ...
      {data && !data.meta?.empty && (
        <KPIGrid
          items={[
            { label: "RECOVERABLE - 7 DAYS", value: currencyCompact(data.recoverable_cash_7d, "SAR") },
            { label: "RECOVERABLE - 14 DAYS", value: currencyCompact(data.recoverable_cash_14d, "SAR") },
            { label: "CASH AT RISK", value: currencyCompact(data.cash_at_risk, "SAR") },
            { label: "EXPECTED COLLECTIONS", value: currencyCompact(data.expected_collections, "SAR") },
          ]}
        />
      )}
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 10 }}>
                      {[
                        { label: "Recoverable", value: currency(item.recoverable_amount, "SAR") },
                        { label: "Expected recovery", value: currency(item.expected_recovery_amount, "SAR") },
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                            ...
                            <span style={{ fontSize: 13, fontWeight: 600, flexShrink: 0, marginLeft: 8 }}>
                              {currency(item.expected_recovery_amount, "SAR")}
                            </span>
                          </div>
