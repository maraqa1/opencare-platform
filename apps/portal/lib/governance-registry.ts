...
const revenueCycleTrustMap: BusinessTrustMap = {
  ...
  nodes: [
    ...
    },
    {
      ...
      uses: ["Cash Overview", "Insurance Performance", "Executive Summary"],
      curated: false,
    },
    {
    ...
    {
      id: "rcm-kpi-command",
      label: "Portal KPI: Cash Overview",
      type: "kpi",
      assetId: "rcm-cash-forecast",
...
const jazanUrbanServiceTrustMap: BusinessTrustMap = {
  title: "Jazan Urban Service Quality Trust Map",
  summary:
    "A product-layer map showing how municipal service sources become governed marts, predictive runtimes, decision-enabled dashboards, and recovery outcomes.",
  focusNodeId: "jazan-mart-service-quality",
  nodes: [
    {
      id: "jazan-source-operations",
      label: "source_jazan.*",
      type: "source",
      description:
        "Municipal operation sources for service requests, visual distortion, permits, coverage, readiness, satisfaction, and municipality reference data.",
      sensitivityClass: "sensitive",
      owner: "Source System Owners",
    ...
    {
      id: "jazan-landing-raw",
      label: "raw_jazan.*",
      type: "landing",
      description: "Raw landing evidence before dbt standardization.",
      sensitivityClass: "sensitive",
    ...
    {
      id: "jazan-staging",
      label: "staging.stg_jazan_*",
      type: "staging",
      description: "Typed and cleaned dbt staging models for municipal service records.",
      sensitivityClass: "sensitive",
      owner: "Data & Analytics Office",
      steward: "Data & Analytics Office",
      freshnessStatus: "warning",
    ...
    {
      id: "jazan-mart-service-quality",
      label: "analytics.fct_jazan_service_quality",
      type: "mart",
      assetId: "jazan-service-quality",
      description: "Governed municipal service quality fact for closure rate, resolution time, SLA, and backlog measures.",
    ...
    {
      id: "jazan-mart-visual-distortion",
      label: "analytics.fct_jazan_visual_distortion_performance",
      type: "mart",
      assetId: "jazan-visual-distortion",
      description: "Governed visual-distortion performance fact for closure quality, repeat cases, and evidence completion.",
      sensitivityClass: "internal",
      owner: "Data & Analytics Office",
      steward: "Data & Analytics Office",
      freshnessStatus: "warning",
    ...
    {
      id: "jazan-runtime-forecast",
      label: "RNN Service Forecast",
      type: "runtime",
      assetId: "jazan-rnn-forecast",
      description: "GRU/LSTM runtime output predicting 4-8 week KPI breach probability.",
      sensitivityClass: "internal",
    ...
    {
      id: "jazan-runtime-risk",
      label: "Municipality Risk Score",
      type: "runtime",
      assetId: "jazan-risk-score",
      description: "Transparent blended score used to rank municipalities for review.",
      sensitivityClass: "internal",
      owner: "Data Science Runtime",
      steward: "Data & Analytics Office",
      freshnessStatus: "warning",
    ...
    {
      id: "jazan-kpi-portal",
      label: "Portal KPI: Urban Service Quality",
      type: "kpi",
      assetId: "jazan-service-quality",
      description: "Target, current status, forecast risk, and trigger state rendered in the OpenCare workspace.",
      sensitivityClass: "internal",
    ...
    {
      id: "jazan-dashboard-superset",
      label: "Superset Urban Service Dashboard",
      type: "dashboard",
      description: "Analytical dashboard consuming governed marts and runtime outputs; not the decision system of record.",
      sensitivityClass: "internal",
      owner: "Data & Analytics Office",
      steward: "Data & Analytics Office",
      freshnessStatus: "warning",
    ...
    {
      id: "jazan-workspace",
      label: "OpenCare Jazan Use Case Workspace",
      type: "workspace",
      description: "Decision-enabled five-screen portal workspace for KPI contracts, models, decisions, actions, and outcomes.",
      sensitivityClass: "internal",
      owner: "Performance Office",
      steward: "Data & Analytics Office",
      freshnessStatus: "warning",
    ...
    {
      id: "jazan-decision-candidates",
      label: "Generated Service Decisions",
      type: "decision",
      assetId: "jazan-generated-decisions",
      description: "Human-review decision candidates generated from forecast, anomaly, risk, and recommendation outputs.",
      sensitivityClass: "internal",
      owner: "Performance Office",
      steward: "Data & Analytics Office",
      freshnessStatus: "warning",
    ...
    },
    {
      ...
      label: "Service Quality Action Queue",
      type: "decision",
      assetId: "jazan-action-queue",
      description: "Corrective action queue created after human approval of decision candidates.",
      sensitivityClass: "internal",
      owner: "Performance Office",
      steward: "Data & Analytics Office",
      freshnessStatus: "warning",
  ...
  edges: [
    { from: "jazan-source-operations", to: "jazan-landing-raw", label: "Ingested as raw landing", curated: false },
    { from: "jazan-landing-raw", to: "jazan-staging", label: "dbt staging", curated: true },
    { from: "jazan-staging", to: "jazan-mart-service-quality", label: "Service quality mart", curated: true },
    { from: "jazan-staging", to: "jazan-mart-visual-distortion", label: "Visual distortion mart", curated: true },
    { from: "jazan-mart-service-quality", to: "jazan-runtime-forecast", label: "Forecast features", curated: true },
    { from: "jazan-mart-visual-distortion", to: "jazan-runtime-forecast", label: "Visual distortion history", curated: true },
    { from: "jazan-runtime-forecast", to: "jazan-runtime-risk", label: "Breach probability", curated: true },
    { from: "jazan-mart-service-quality", to: "jazan-kpi-portal", label: "KPI monitoring", curated: true },
    { from: "jazan-runtime-risk", to: "jazan-workspace", label: "Risk ranking", curated: true },
    { from: "jazan-mart-visual-distortion", to: "jazan-dashboard-superset", label: "Analytical evidence", curated: true },
    { from: "jazan-workspace", to: "jazan-decision-candidates", label: "Decision candidate review", curated: true },
    { from: "jazan-decision-candidates", to: "jazan-action-queue", label: "Human approval creates action", curated: true },
  ],
};
...
const governanceUseCases: GovernanceUseCase[] = [
  ...
  },
  {
    ...
    workspaceCoverage: [
      { label: "Cash Overview", href: "/use-cases/revenue-cycle-management/cash-command" },
      { label: "Recovery Work Queue", href: "/use-cases/revenue-cycle-management/recovery-queue" },
      { label: "Insurance Performance", href: "/use-cases/revenue-cycle-management/payer-control" },
      { label: "Revenue Loss", href: "/use-cases/revenue-cycle-management/revenue-leakage" },
      { label: "Team Performance", href: "/use-cases/revenue-cycle-management/team-performance" },
      { label: "Executive Summary", href: "/use-cases/revenue-cycle-management/executive-narrative" },
    ],
    governedDatasets: [
      {
        ...
        consumers: ["Recovery Work Queue", "Cash Overview", "Executive dashboard"],
        downstreamConsumers: ["Recovery Work Queue", "Cash Overview", "Team Performance"],
        ...
        columns: [
          ...
          datasetColumn("payer_id", "text", "sensitive", "Insurer identifier for recovery routing.", {
            suppressedInWorkspace: true,
          }),
      ...
      },
      {
        ...
        consumers: ["Cash Overview", "Executive Summary"],
        downstreamConsumers: ["Cash Overview", "CFO dashboard"],
      ...
      },
      {
        ...
        name: "Insurer Contract Performance",
        schema: "analytics",
        ...
        owner: "Insurer Performance Analytics",
        steward: "Insurer Relations Lead",
        freshnessStatus: "fresh",
        testStatus: "passing",
        lineageStatus: "partial",
        recordSpecStatus: "complete",
        ...
        consumers: ["Insurance Performance", "Executive dashboard", "Contract review"],
        downstreamConsumers: ["Insurance Performance", "Executive Summary"],
        ...
        columns: [
          datasetColumn("payer_id", "text", "sensitive", "Insurer identifier.", { suppressedInWorkspace: true }),
      ...
      },
      {
        ...
        consumers: ["Team Performance", "Executive Summary"],
      ...
      },
      {
        ...
        consumers: ["Cash Overview", "Revenue analytics", "Governance"],
        downstreamConsumers: ["Cash Forecast", "Cash Overview", "Revenue-loss analysis"],
      ...
      },
      {
        ...
        consumers: ["Cash Overview", "Executive dashboard", "Insurance Performance"],
        downstreamConsumers: ["Revenue Cycle Fact", "Cash Forecast", "Insurer Contract Performance"],
      ...
      },
      {
        ...
        owner: "Outstanding Balance Analytics",
        steward: "Revenue Integrity Lead",
        freshnessStatus: "warning",
        testStatus: "warning",
        lineageStatus: "partial",
        ...
        consumers: ["Cash Overview", "Insurance Performance", "Executive dashboard"],
        downstreamConsumers: ["Cash Overview", "Insurance Performance"],
      ...
      },
      {
        ...
        consumers: ["Recovery Work Queue", "Insurance Performance", "Superset dashboard"],
        downstreamConsumers: ["Recovery Work Queue", "Insurance Performance"],
      ...
      },
      {
        ...
        consumers: ["Revenue Loss workspace", "Executive dashboard"],
        downstreamConsumers: ["Revenue Loss", "Executive Summary"],
        upstreamSources: ["raw.claims", "raw.denials", "analytics.fct_financial_posting"],
        relatedDashboards: ["Revenue Cycle Executive Command"],
      ...
      },
      {
        ...
        name: "Insurer Performance Summary",
        schema: "analytics",
        ...
        consumers: ["Executive dashboard", "Insurer reviews"],
        downstreamConsumers: ["Executive Summary"],
      ...
      },
      {
        ...
        consumers: ["Executive Summary", "Growth reporting"],
        downstreamConsumers: ["Executive Summary"],
    ...
    dictionaryTerms: [
      ...
      },
      {
        ...
        steward: "Revenue Integrity Lead",
        exampleUsage: "An insurer with a rising rejected claim rate should move into the Insurance Performance view.",
      ...
      },
      {
        ...
        term: "Insurer Payment Turnaround Time",
    ...
    lineageEntryPoints: [
      {
        ...
        impactTargets: ["Cash Overview", "CFO dashboard"],
        status: "partial",
      },
      {
        id: "rcm-lineage-payer-control",
        label: "Insurance performance technical lineage",
        summary: "Technical lineage for payer contract and aging evidence.",
        technicalModel: "fct_payer_contract_performance",
        impactTargets: ["Insurance Performance", "Executive Summary"],
        status: "partial",
      },
      {
        ...
        impactTargets: ["Revenue Loss", "Executive Summary", "Superset dashboard"],
        status: "partial",
      },
    ],
    qualitySummary: {
