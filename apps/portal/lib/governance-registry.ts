...
const governanceUseCases: GovernanceUseCase[] = [
  {
    ...
    qualitySummary: {
      ...
      recordSpecs: "partial",
      compliance: "warning",
      note: "Core bed-pressure assets now show stronger governance evidence, while runtime outputs and decision surfaces remain partially connected.",
    },
    complianceContext: {
      posture: "warning",
  ...
  },
  {
    ...
    qualitySummary: {
      ...
      compliance: "warning",
      note: "Revenue Cycle has broad record-spec coverage with stronger governance evidence on core financial facts, while a few secondary assets remain partial or stale.",
    },
    complianceContext: {
      posture: "warning",
