  ...
  nodes: [
    {
      ...
      label: "source_jazan.*",
      type: "source",
      description: "Municipal operation sources for service requests, visual distortion, permits, coverage, readiness, satisfaction, and municipality reference data.",
