...
- Governance, lineage, dictionary, record specification, extraction quality, and reconciliation belong in Platform -> Administration -> Governance -> Use Case, not as TALEMIA operational workspace tabs.
