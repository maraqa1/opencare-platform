...
ANOMALY_LOOKBACK_DAYS="${ANOMALY_LOOKBACK_DAYS:-14}"
ANOMALY_RECENT_WINDOW_DAYS="${ANOMALY_RECENT_WINDOW_DAYS:-7}"
ANOMALY_MIN_DEVIATION_RATIO="${ANOMALY_MIN_DEVIATION_RATIO:-0.15}"
ANOMALY_MIN_ABS_DELTA="${ANOMALY_MIN_ABS_DELTA:-2}"
