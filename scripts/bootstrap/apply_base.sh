...
data:
  ...
  LOCAL_AI_KEEP_ALIVE: "${LOCAL_AI_KEEP_ALIVE}"
  LOCAL_AI_WARM_MAX_SECONDS: "${LOCAL_AI_WARM_MAX_SECONDS}"
  ...
  CERT_MANAGER_RELEASE_NAME: ${CERT_MANAGER_RELEASE_NAME}
  CERT_MANAGER_CHART_REPO_NAME: ${CERT_MANAGER_CHART_REPO_NAME}
  CERT_MANAGER_CHART_REPO_URL: ${CERT_MANAGER_CHART_REPO_URL}
  CERT_MANAGER_CHART_NAME: ${CERT_MANAGER_CHART_NAME}
